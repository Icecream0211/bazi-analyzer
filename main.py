...
from routers import api_stream_base_analysis, api_base_analysis, api_bazi_need, api_career_analysis, api_dayun_analysis, api_love_analysis, api_xiji_analysis
...
app.include_router(api_stream_base_analysis.router)
